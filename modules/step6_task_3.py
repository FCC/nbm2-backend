...
def makeSpeedTile(input_queue, output_queue, message_queue, config, start_time):
    """
    combines all of the zoom levels to create a single tile file for each
    speed
    ...
    try:
        ...
        for i in range(config['number_servers']):
            message_queue.put('speed_mbtile')
        ...
        my_message = """
            INFO - STEP 6 (MASTER): TASK 3 OF 5 - COMPLETED CREATING A SINGLE
            TILE FOR EACH SPEED
            """
        ...
        my_message = """
            ERROR - STEP 6 (MASTER): TASK 3 OF 5 - FAILED CREATING A SINGLE 
            TILE FOR EACH SPEED 
            """
