...
def makeProviderTiles(input_queue, output_queue, message_queue, config, 
                    start_time):
    """
    combines the information from the four provider files created in task 4
    into two map box tiles (one for large providers and one for other 
    providers)
    ...
    try:
        ...
        my_message = """
            INFO - STEP 6 (MASTER): TASK 5 OF 5 - COMPLETED MAKING 
            PROVIDER FILES
            """
        ...
        my_message = """
            ERROR - STEP 6 (MASTER): TASK 5 OF 5 - FAILED MAKING 
            PROVIDER FILES 
            """
